###########################################################################
## Makefile generated for component 'Motor_position_control_P'. 
## 
## Makefile     : Motor_position_control_P.mk
## Generated on : Thu Oct 20 16:35:50 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Motor_position_control_P.elf
...
PRODUCT_NAME              = Motor_position_control_P
MAKEFILE                  = Motor_position_control_P.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Motor_position_control_P.elf
...
DEFINES_STANDARD = -DMODEL=Motor_position_control_P -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/Motor_position_control_P_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Motor_position_control_P_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Motor_position_control_P_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Motor_position_control_P_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Motor_position_control_P_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Motor_position_control_P.o : $(START_DIR)/Motor_position_control_P_ert_rtw/Motor_position_control_P.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Motor_position_control_P_data.o : $(START_DIR)/Motor_position_control_P_ert_rtw/Motor_position_control_P_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Motor_position_control_P_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Motor_position_control_P_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Motor_position_control_P_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Motor_position_control_P_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
