 ...
 *
 * File: PWM_sinewave_PI_with_TF.h
 *
...
#ifndef RTW_HEADER_PWM_sinewave_PI_with_TF_h_
#define RTW_HEADER_PWM_sinewave_PI_with_TF_h_
#ifndef PWM_sinewave_PI_with_TF_COMMON_INCLUDES_
#define PWM_sinewave_PI_with_TF_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "MW_PWM.h"
#endif                            /* PWM_sinewave_PI_with_TF_COMMON_INCLUDES_ */
...
} B_PWM_sinewave_PI_with_TF_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  codertarget_arduinobase_block_T obj; /* '<S9>/Digital Input' */
  codertarget_arduinobase_blo_b_T obj_p;/* '<S1>/Digital Output1' */
  codertarget_arduinobase_blo_b_T obj_o;/* '<S1>/Digital Output' */
...
typedef struct {
  ...
  real_T TransferFcn1_CSTATE;          /* '<Root>/Transfer Fcn1' */
  real_T TransferFcn3_CSTATE;          /* '<Root>/Transfer Fcn3' */
} XDot_PWM_sinewave_PI_with_TF_T;
...
} XDis_PWM_sinewave_PI_with_TF_T;
...
struct P_PWM_sinewave_PI_with_TF_T_ {
  ...
  real_T Gain2_Gain;                   /* Expression: 0.00255
                                        ...
                                        */
  real_T Gain1_Gain;                   /* Expression: 0.38
  ...
  real_T Gain2_Gain_e;                 /* Expression: 1/2
                                        ...
                                        */
  real_T Gain1_Gain_a;                 /* Expression: 255/12
...
struct tag_RTM_PWM_sinewave_PI_with__T {
  const char_T *errorStatus;
  RTWExtModeInfo *extModeInfo;
  RTWSolverInfo solverInfo;
  X_PWM_sinewave_PI_with_TF_T *contStates;
...
extern P_PWM_sinewave_PI_with_TF_T PWM_sinewave_PI_with_TF_P;

/* Block signals (default storage) */
extern B_PWM_sinewave_PI_with_TF_T PWM_sinewave_PI_with_TF_B;

/* Continuous states (default storage) */
extern X_PWM_sinewave_PI_with_TF_T PWM_sinewave_PI_with_TF_X;

/* Block states (default storage) */
extern DW_PWM_sinewave_PI_with_TF_T PWM_sinewave_PI_with_TF_DW;

/* Model entry point functions */
extern void PWM_sinewave_PI_with_TF_initialize(void);
extern void PWM_sinewave_PI_with_TF_step(void);
extern void PWM_sinewave_PI_with_TF_terminate(void);

/* Real-time Model object */
extern RT_MODEL_PWM_sinewave_PI_with_T *const PWM_sinewave_PI_with_TF_M;
 ...
 *
 * '<Root>' : 'PWM_sinewave_PI_with_TF'
 * '<S1>'   : 'PWM_sinewave_PI_with_TF/Motor'
 * '<S2>'   : 'PWM_sinewave_PI_with_TF/Stair Generator'
 * '<S3>'   : 'PWM_sinewave_PI_with_TF/Subsystem'
 * '<S4>'   : 'PWM_sinewave_PI_with_TF/encoder'
 * '<S5>'   : 'PWM_sinewave_PI_with_TF/Stair Generator/Discrete'
 * '<S6>'   : 'PWM_sinewave_PI_with_TF/Stair Generator/Discrete/While Iterator Subsystem'
 * '<S7>'   : 'PWM_sinewave_PI_with_TF/Stair Generator/Discrete/While Iterator Subsystem/Detect Fall Nonpositive'
 * '<S8>'   : 'PWM_sinewave_PI_with_TF/Stair Generator/Discrete/While Iterator Subsystem/Detect Fall Nonpositive/Nonpositive'
 * '<S9>'   : 'PWM_sinewave_PI_with_TF/encoder/Triggered Subsystem'
 */
#endif                               /* RTW_HEADER_PWM_sinewave_PI_with_TF_h_ */
