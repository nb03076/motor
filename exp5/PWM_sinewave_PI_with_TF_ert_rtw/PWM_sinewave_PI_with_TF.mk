###########################################################################
## Makefile generated for component 'PWM_sinewave_PI_with_TF'. 
## 
## Makefile     : PWM_sinewave_PI_with_TF.mk
## Generated on : Mon Oct 17 22:04:46 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/PWM_sinewave_PI_with_TF.elf
...
PRODUCT_NAME              = PWM_sinewave_PI_with_TF
MAKEFILE                  = PWM_sinewave_PI_with_TF.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PWM_sinewave_PI_with_TF.elf
...
DEFINES_STANDARD = -DMODEL=PWM_sinewave_PI_with_TF -DNUMST=2 -DNCSTATES=3 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/PWM_sinewave_PI_with_TF_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/PWM_sinewave_PI_with_TF_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/PWM_sinewave_PI_with_TF_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/PWM_sinewave_PI_with_TF_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/PWM_sinewave_PI_with_TF_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PWM_sinewave_PI_with_TF.o : $(START_DIR)/PWM_sinewave_PI_with_TF_ert_rtw/PWM_sinewave_PI_with_TF.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PWM_sinewave_PI_with_TF_data.o : $(START_DIR)/PWM_sinewave_PI_with_TF_ert_rtw/PWM_sinewave_PI_with_TF_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/PWM_sinewave_PI_with_TF_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/PWM_sinewave_PI_with_TF_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/PWM_sinewave_PI_with_TF_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/PWM_sinewave_PI_with_TF_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
