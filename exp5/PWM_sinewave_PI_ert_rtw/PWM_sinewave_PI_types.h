...
#ifndef RTW_HEADER_PWM_sinewave_PI_types_h_
#define RTW_HEADER_PWM_sinewave_PI_types_h_
#include "rtwtypes.h"
#include "MW_SVD.h"
...
#ifndef typedef_codertarget_arduinobase_blo_m_T
#define typedef_codertarget_arduinobase_blo_m_T

typedef struct tag_qrLkTWTW64zZK0sqwALTyG codertarget_arduinobase_blo_m_T;

#endif                             /* typedef_codertarget_arduinobase_blo_m_T */

/* Parameters (default storage) */
typedef struct P_PWM_sinewave_PI_T_ P_PWM_sinewave_PI_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_PWM_sinewave_PI_T RT_MODEL_PWM_sinewave_PI_T;

#endif                                 /* RTW_HEADER_PWM_sinewave_PI_types_h_ */
