...
void rt_OneStep(void)
{
  ...
  Motor_position_control_P_2_step();
...
int main(void)
{
  ...
  init();
  MW_Arduino_Init();
  rtmSetErrorStatus(Motor_position_control_P_2_M, 0);
  ...
  Motor_position_control_P_2_initialize();
  noInterrupts();
  interrupts();

  /* External Mode initialization */
  errorCode = extmodeInit(Motor_position_control_P_2_M->extModeInfo,
    &rtmGetTFinal(Motor_position_control_P_2_M));
  if (errorCode != EXTMODE_SUCCESS) {
  ...
  if (errorCode == EXTMODE_SUCCESS) {
    ...
    if (extmodeStopRequested()) {
      rtmSetStopRequested(Motor_position_control_P_2_M, true);
    }
  }
  ...
  runModel = !extmodeSimulationComplete() && !extmodeStopRequested() &&
    !rtmGetStopRequested(Motor_position_control_P_2_M);
  ...
  /* Terminate model */
  Motor_position_control_P_2_terminate();
