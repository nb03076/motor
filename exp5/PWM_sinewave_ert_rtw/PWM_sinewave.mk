###########################################################################
## Makefile generated for component 'PWM_sinewave'. 
## 
## Makefile     : PWM_sinewave.mk
## Generated on : Thu Oct 13 15:59:05 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/PWM_sinewave.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PWM_sinewave.elf
...
DEFINES_STANDARD = -DMODEL=PWM_sinewave -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/PWM_sinewave_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/PWM_sinewave_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/PWM_sinewave_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/PWM_sinewave_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/PWM_sinewave_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PWM_sinewave.o : $(START_DIR)/PWM_sinewave_ert_rtw/PWM_sinewave.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PWM_sinewave_data.o : $(START_DIR)/PWM_sinewave_ert_rtw/PWM_sinewave_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/PWM_sinewave_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/PWM_sinewave_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/PWM_sinewave_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/PWM_sinewave_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
