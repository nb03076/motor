###########################################################################
## Makefile generated for component 'dcmotor_transfer_func'. 
## 
## Makefile     : dcmotor_transfer_func.mk
## Generated on : Fri Sep 30 17:17:40 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/dcmotor_transfer_func.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/dcmotor_transfer_func.elf
...
DEFINES_STANDARD = -DMODEL=dcmotor_transfer_func -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/dcmotor_transfer_func_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/dcmotor_transfer_func_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/dcmotor_transfer_func_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/dcmotor_transfer_func_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/dcmotor_transfer_func_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
dcmotor_transfer_func.o : $(START_DIR)/dcmotor_transfer_func_ert_rtw/dcmotor_transfer_func.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dcmotor_transfer_func_data.o : $(START_DIR)/dcmotor_transfer_func_ert_rtw/dcmotor_transfer_func_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/dcmotor_transfer_func_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
